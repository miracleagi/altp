...
struct KeyboardShortcut: Equatable {
    ...
    static func isAllowed(keyCode: UInt32, modifiers: UInt32) -> Bool {
        ...
        return keyCode >= UInt32(kVK_F1) && keyCode <= UInt32(kVK_F20)
    }
}
...
enum ShortcutFormatter {
    static func displayString(keyCode: UInt32, modifiers: UInt32) -> String {
        let prefix = modifierSymbols(modifiers: modifiers).joined()
    ...
    private static func modifierSymbols(modifiers: UInt32) -> [String] {
        var symbols: [String] = []
